...
{    
    ...
    export function loadSlide()
    {
        // geht
        var a = compose(
            { P:{ re:0.4960541644705069, im:-0.7416309570144335 }, θ:{ re:1, im:0 } },
            shift(
                { P:{ re: 0.24869964486594093, im:0.27044815565352776}, θ:{ re:1, im:0 } },
                    { re: 0.3284810185432434, im:-0.8088113069534302},
                maxR({re: -0.3914557099342346, im:0.5282139778137207}, .95)
            )
        )
        console.log(a.P)
        ...
        var b = compose(
            { P:{ re:0.4960541644705069, im:-0.7416309570144335 }, θ:{ re:1, im:0 } },
            shift(
                { P:{ re:0.05729413166688675, im:0.11095930940078638}, θ:{ re:1, im:0 } },
                    { re:0.3284810185432434, im:-0.8088113069534302},
                maxR({ re:-0.399367094039917, im:0.5361254215240479}, .95)
            )
        )
        console.log(b.P)
