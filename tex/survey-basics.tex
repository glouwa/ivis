...
\end{tabu}
\captionof{figure}{4 different types of graphs (top: weighted directed and undirected, bottom: unweighted directed and undirected)\imgcredit{Figure created by an author of this thesis using GoogleDraw.}\label{fig:graph_types}}
\end{table}
...
\end{tabu}
\captionof{figure}{4 differnet patterns: star, full, circle and line\imgcredit{Figure created by an author of this thesis using GoogleDraw.}\label{fig:patterns}}
\end{table}
