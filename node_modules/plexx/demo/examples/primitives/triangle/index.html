...
<head>
    ...
    <title>Plexx.js example: Triangle</title>
</head>

<body>
<h1>Plexx.js examples: Primitives - Triangle</h1>
...
<table>
    ...
    <tr>
        ...
        <th>create a triangle at positions (-10,-10), (20,20), (0,30)</th>
    </tr>
    <tr>
        <th>Translation</th>
        <th>
        ...
        <th>translate the triangle to position (10,20)</th>
    </tr>
    <tr>
        <th>Scale</th>
        <th>
        ...
        <th>scale the triangle times 2 in x and times 1/2 in y</th>
    </tr>
    <tr>
        <th>Rotation</th>
        <th>
        ...
        <th>rotate the triangle -30 degrees</th>
    </tr>
...
<script>
    ...
    var triangle = new Plexx.Triangle({
        positionA: [-10, -10],
        positionB: [20, 20],
        positionC: [0, 30],
    ...
    var trianglePointA = new Plexx.Circle({
        radius: 2,
        position: [-10, -10],
        colour: pointColour
    });

    var trianglePointB = new Plexx.Circle({
        radius: 2,
        position: [20, 20],
        colour: pointColour
    });

    var trianglePointC = new Plexx.Circle({
        radius: 2,
        position: [0, 30],
        colour: pointColour
    });
    ...
    myGroup.add(trianglePointA);
    myGroup.add(trianglePointB);
    myGroup.add(trianglePointC);
    ...
    triangle.setTranslation([10, 20]);
    trianglePointA.setTranslation([10, 20]);
    trianglePointB.setTranslation([10, 20]);
    trianglePointC.setTranslation([10, 20]);
    ...
    triangle.setScale([2, (1/2)]);
    trianglePointA.isHidden = true;
    trianglePointB.isHidden = true;
    trianglePointC.isHidden = true;
