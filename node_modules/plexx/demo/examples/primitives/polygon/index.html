...
<head>
    ...
    <title>Plexx.js example: Polygon</title>
</head>

<body>
<h1>Plexx.js examples: Primitives - Polygon</h1>
...
<table>
    ...
    <tr>
        ...
        <th>create a polygon at positions (0, 0), (6, 19), (-10, 30), (10, 30), (15, 48), (21, 30), (41, 30), (25, 19), (30, 0), (15, 10)
    </tr>
    <tr>
        <th>Translation</th>
        <th>
        ...
        <th>translate the polygon to position (10,20)</th>
    </tr>
    <tr>
        <th>Scale</th>
        <th>
        ...
        <th>scale the polygon times 1/2 in x and times 2/3 in y</th>
    </tr>
    <tr>
        <th>Rotation</th>
        <th>
        ...
        <th>rotate the polygon -30 degrees</th>
    </tr>
...
<script>
    ...
    var polygon = new Plexx.Polygon({
        points: [0, 0, 6, 19, -10, 30, 10, 30, 15, 48, 21, 30, 41, 30, 25, 19, 30, 0, 15, 10],
        colour: primitiveColour
    });

    var polygonPoint1 = new Plexx.Circle({
        radius: 2,
        position: [0, 0],
        colour: pointColour
    });
    var polygonPoint2 = new Plexx.Circle({
        radius: 2,
        position: [6, 19],
        colour: pointColour
    });
    var polygonPoint3 = new Plexx.Circle({
        radius: 2,
        position: [-10, 30],
        colour: pointColour
    });
    var polygonPoint4 = new Plexx.Circle({
        radius: 2,
        position: [10, 30],
        colour: pointColour
    });
    var polygonPoint5 = new Plexx.Circle({
        radius: 2,
        position: [15, 48],
        colour: pointColour
    });
    var polygonPoint6 = new Plexx.Circle({
        radius: 2,
        position: [21, 30],
        colour: pointColour
    });
    var polygonPoint7 = new Plexx.Circle({
        radius: 2,
        position: [41, 30],
        colour: pointColour
    });
    var polygonPoint8 = new Plexx.Circle({
        radius: 2,
        position: [25, 19],
        colour: pointColour
    });
    var polygonPoint9 = new Plexx.Circle({
        radius: 2,
        position: [30, 0],
        colour: pointColour
    });
    var polygonPoint10 = new Plexx.Circle({
        radius: 2,
        position: [15, 10],
        colour: pointColour
    });
    ...
    myGroup.add(yAxis);
    myGroup.add(polygon);
    myGroup.add(polygonPoint1);
    myGroup.add(polygonPoint2);
    myGroup.add(polygonPoint3);
    myGroup.add(polygonPoint4);
    myGroup.add(polygonPoint5);
    myGroup.add(polygonPoint6);
    myGroup.add(polygonPoint7);
    myGroup.add(polygonPoint8);
    myGroup.add(polygonPoint9);
    myGroup.add(polygonPoint10);
    ...
    polygon.setTranslation([10, 20]);
    polygonPoint1.setTranslation([10, 20]);
    polygonPoint2.setTranslation([10, 20]);
    polygonPoint3.setTranslation([10, 20]);
    polygonPoint4.setTranslation([10, 20]);
    polygonPoint5.setTranslation([10, 20]);
    polygonPoint6.setTranslation([10, 20]);
    polygonPoint7.setTranslation([10, 20]);
    polygonPoint8.setTranslation([10, 20]);
    polygonPoint9.setTranslation([10, 20]);
    polygonPoint10.setTranslation([10, 20]);
    ...
    polygon.setScale([(1/2), (2/3)]);
    polygonPoint1.isHidden = true;
    polygonPoint2.isHidden = true;
    polygonPoint3.isHidden = true;
    polygonPoint4.isHidden = true;
    polygonPoint5.isHidden = true;
    polygonPoint6.isHidden = true;
    polygonPoint7.isHidden = true;
    polygonPoint8.isHidden = true;
    polygonPoint9.isHidden = true;
    polygonPoint10.isHidden = true;
