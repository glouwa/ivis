...
<head>
    ...
    <title>Plexx.js example: Primitives</title>
</head>

<body>
<h1>Plexx.js examples: Primitives - Rectangle</h1>
...
<table>
    ...
    <tr>
        ...
        <th>create a rectangle with width = 30 and height = 20 at position (0, 0)</th>
    </tr>
    <tr>
        <th>Translation</th>
        <th>
        ...
        <th>translate the rectangle to position (10,20)</th>
    </tr>
    <tr>
        <th>Scale</th>
        <th>
        ...
        <th>scale the rectangle times 2/3 in x and times 2 in y</th>
    </tr>
    <tr>
        <th>Rotation</th>
        <th>
        ...
        <th>rotate the rectangle -30 degrees</th>
    </tr>
...
<script>
    ...
    var rectangle = new Plexx.Rectangle({
        width: 30,
        height: 20,
        position: [0, 0],
    ...
    var rectanglePoint = new Plexx.Circle({
        radius: 2,
        position: [0, 0],
        colour: pointColour
    });
    ...
    rectangle.setTranslation([10, 20]);
    rectanglePoint.setTranslation([10, 20]);
