...
<head>
    ...
    <title>Plexx.js example: Circle</title>
</head>

<body>
<h1>Plexx.js examples: Primitives - Circle</h1>
...
<table>
    ...
    <tr>
        ...
        <th>create a circle with radius = 10 at position (0, 0)</th>
    </tr>
    <tr>
        <th>Translation</th>
        <th>
        ...
        <th>translate the circle to position (10,20)</th>
    </tr>
    <tr>
        <th>Scale</th>
        <th>
        ...
        <th>scale the circle times 1/2 in x and times 2 in y</th>
    </tr>
    <tr>
        <th>Rotation</th>
        <th>
        ...
        <th>rotate the circle -30 degrees</th>
    </tr>
...
<script>
    ...
    circle.setTranslation([10, 20]);
    circlePoint.setTranslation([10, 20]);
