...
(function (ivis) {
    ...
    (function (layouts) {
        ...
        layouts.layoutAtCenter = layoutAtCenter;
        ...
        layouts.layoutRadial = layoutRadial;
        function layoutHyperbolic(n, wedge = { p: { re: 0, im: 0 }, m: { re: 0, im: 1 }, α: Math.PI }) {
            console.log('--------------------------------------------------------', n.depth);
        ...
        layouts.layoutHyperbolic = layoutHyperbolic;
        /*
    ...
    })(layouts = ivis.layouts || (ivis.layouts = {}));
})(ivis || (ivis = {}));
